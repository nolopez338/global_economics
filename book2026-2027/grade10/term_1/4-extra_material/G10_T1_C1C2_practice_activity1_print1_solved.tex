...
\begin{document}
	\vspace{-8mm}	
	\textbf{(C1)} \textit{Identify the decision alternatives, the states of nature, the uncertain event, and the payoff components}. Then \textbf{(C2)} \textit{construct the corresponding payoff table}. \vspace{-7mm}
