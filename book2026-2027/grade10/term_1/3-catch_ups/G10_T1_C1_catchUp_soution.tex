...
\begin{document}
	\ExamTitleBlock{10th grade}{Term 1 C1 Catch-Up Activity (Solutions)}{}
	...
	\begin{ExamProblems}
		...
		\textbf{Step 2 --- Compare expected values.}
		Among the five designs, Design E has the largest expected value at $183.0$.
	...
	\[
	\begin{aligned}
	EV(\text{Rent kiosk}) &= 36(0.60)+10(0.40)=25.6
	\end{aligned}
	\]
	\[
	\text{Choice: Rent kiosk}
	\]

	\section*{Problem 2}
	\[
	\begin{aligned}
	EV(\text{Plan A}) &= 84(0.55)+22(0.45)=56.1,\\
	EV(\text{Plan B}) &= 72(0.55)+34(0.45)=54.9
	\end{aligned}
	\]
	\[
	\max EV = 56.1 \;\Rightarrow\; \text{Choice: Plan A}
	\]

	\section*{Problem 3}
	\[
	\begin{aligned}
	EV(\text{Mode A}) &= 95(0.30)+60(0.45)+18(0.25)=60.0,\\
	EV(\text{Mode B}) &= 88(0.30)+66(0.45)+30(0.25)=63.6
	\end{aligned}
	\]
	\[
	\max EV = 63.6 \;\Rightarrow\; \text{Choice: Mode B}
	\]

	\section*{Problem 4}
	\[
	\begin{aligned}
	EV(\text{Strategy A}) &= 120(0.25)+86(0.50)+44(0.25)=84.0,\\
	EV(\text{Strategy B}) &= 108(0.25)+92(0.50)+58(0.25)=87.5,\\
	EV(\text{Strategy C}) &= 96(0.25)+88(0.50)+70(0.25)=85.5
	\end{aligned}
	\]
	\[
	\max EV = 87.5 \;\Rightarrow\; \text{Choice: Strategy B}
	\]

	\section*{Problem 5}
	\[
	\begin{aligned}
	EV(\text{Policy A}) &= 74(0.20)+68(0.35)+36(0.30)+8(0.15)=50.6,\\
	EV(\text{Policy B}) &= 82(0.20)+76(0.35)+50(0.30)+24(0.15)=61.6,\\
	EV(\text{Policy C}) &= 86(0.20)+78(0.35)+58(0.30)+34(0.15)=67.0
	\end{aligned}
	\]
	\[
	\max EV = 67.0 \;\Rightarrow\; \text{Choice: Policy C}
	\]

	\section*{Problem 6}
	\[
	\begin{aligned}
	EV(\text{Format A}) &= 150(0.20)+110(0.30)+72(0.30)+30(0.20)=90.6,\\
	EV(\text{Format B}) &= 132(0.20)+118(0.30)+82(0.30)+48(0.20)=96.0,\\
	EV(\text{Format C}) &= 144(0.20)+124(0.30)+94(0.30)+62(0.20)=106.6,\\
	EV(\text{Format D}) &= 120(0.20)+108(0.30)+88(0.30)+66(0.20)=96.0
	\end{aligned}
	\]
	\[
	\max EV = 106.6 \;\Rightarrow\; \text{Choice: Format C}
	\]

	\section*{Problem 7}
	\[
	\begin{aligned}
	EV(\text{Contract A}) &= 160(0.15)+138(0.25)+102(0.30)+66(0.20)+24(0.10)=104.7,\\
	EV(\text{Contract B}) &= 152(0.15)+140(0.25)+114(0.30)+80(0.20)+40(0.10)=112.0,\\
	EV(\text{Contract C}) &= 146(0.15)+136(0.25)+120(0.30)+92(0.20)+54(0.10)=115.7,\\
	EV(\text{Contract D}) &= 132(0.15)+126(0.25)+116(0.30)+98(0.20)+70(0.10)=112.7
	\end{aligned}
	\]
	\[
	\max EV = 115.7 \;\Rightarrow\; \text{Choice: Contract C}
	\]

	\section*{Problem 8}
	\[
	\begin{aligned}
	EV(\text{Plan A}) &= 190(0.12)+150(0.23)+108(0.30)+58(0.22)+12(0.13)=104.02,\\
	EV(\text{Plan B}) &= 182(0.12)+154(0.23)+120(0.30)+76(0.22)+34(0.13)=114.4,\\
	EV(\text{Plan C}) &= 176(0.12)+152(0.23)+128(0.30)+90(0.22)+52(0.13)=121.04,\\
	EV(\text{Plan D}) &= 168(0.12)+146(0.23)+126(0.30)+98(0.22)+64(0.13)=121.42,\\
	EV(\text{Plan E}) &= 156(0.12)+140(0.23)+124(0.30)+104(0.22)+76(0.13)=120.88
	\end{aligned}
	\]
	\[
	\max EV = 121.42 \;\Rightarrow\; \text{Choice: Plan D}
	\]

	\section*{Problem 9}
	\[
	\begin{aligned}
	EV(\text{Package A}) &= 220(0.10)+184(0.20)+142(0.25)+96(0.20)+58(0.15)+22(0.10)=124.4,\\
	EV(\text{Package B}) &= 210(0.10)+186(0.20)+152(0.25)+110(0.20)+74(0.15)+40(0.10)=133.3,\\
	EV(\text{Package C}) &= 204(0.10)+182(0.20)+158(0.25)+122(0.20)+88(0.15)+54(0.10)=139.3,\\
	EV(\text{Package D}) &= 196(0.10)+176(0.20)+156(0.25)+128(0.20)+98(0.15)+68(0.10)=140.9,\\
	EV(\text{Package E}) &= 186(0.10)+170(0.20)+152(0.25)+130(0.20)+106(0.15)+82(0.10)=140.7
	\end{aligned}
	\]
	\[
	\max EV = 140.9 \;\Rightarrow\; \text{Choice: Package D}
	\]

	\section*{Problem 10}
	\[
	\begin{aligned}
	EV(\text{Design A}) &= 260(0.14)+220(0.20)+170(0.24)+118(0.16)+70(0.12)+136(0.14)=167.52,\\
	EV(\text{Design B}) &= 248(0.14)+222(0.20)+182(0.24)+132(0.16)+86(0.12)+148(0.14)=174.96,\\
	EV(\text{Design C}) &= 242(0.14)+218(0.20)+188(0.24)+146(0.16)+102(0.12)+158(0.14)=180.32,\\
	EV(\text{Design D}) &= 234(0.14)+212(0.20)+190(0.24)+156(0.16)+118(0.12)+164(0.14)=182.84,\\
	EV(\text{Design E}) &= 226(0.14)+206(0.20)+188(0.24)+162(0.16)+130(0.12)+168(0.14)=183.0
	\end{aligned}
	\]
	\[
	\max EV = 183.0 \;\Rightarrow\; \text{Choice: Design E}
	\]
