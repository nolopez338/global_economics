...
The superscript \(A\) marks an alternative-based component whose argument is
\(A_i\), and the superscript \(S\) marks a state-based component whose argument
is \(S_j\). The quantity \(q(A_i,S_j)\) depends on both arguments and may
...
\begin{enumerate}[label=\textbf{\alph*)}]
	\item
	\TaskHyperref{subsec:problem1-introductory-general-c1}
	{\textbf{(C1)} Interpret the decision elements.}
	
	\item
	\TaskHyperref{subsec:problem1-introductory-general-c3}
	{\textbf{(C3)} Build the payoff table.}
\end{enumerate}

\subsubsection*{a) \textbf{(C1)} Interpreting the decision.}
\phantomsection
...
\subsubsection*{b) \textbf{(C3)} Calculating revenue, cost, and payoff.}
\phantomsection
...
\begin{enumerate}[label=\textbf{\alph*)}]
	\item
	\TaskHyperref{subsec:problem2-advanced-general-c1}
	{\textbf{(C1)} Interpret the decision elements.}
	
	\item
	\TaskHyperref{subsec:problem2-advanced-general-c3}
	{\textbf{(C3)} Build the payoff table.}
\end{enumerate}
...
\begin{enumerate}[label=\textbf{\alph*)}]
	\item
	\TaskHyperref{subsec:problem3-local-cafe-investment-c1}
	{\textbf{(C1)} Interpreting decision alternatives, events, consequences, and states.}
	
	\item
	\TaskHyperref{subsec:problem3-local-cafe-investment-c3}
	{\textbf{(C3)} Calculating profit and building the payoff table.}
\end{enumerate}
...
\subsubsection*{b) \textbf{(C3)} Calculating profit and building the payoff table.}
\phantomsection
...
\begin{enumerate}[label=\textbf{\alph*)}]
	\item
	\TaskHyperref{subsec:problem4-green-energy-production-mix-c1}
	{\textbf{(C1)} Interpreting decision alternatives, events, consequences, and states.}
	
	\item
	\TaskHyperref{subsec:problem4-green-energy-production-mix-c3}
	{\textbf{(C3)} Calculating profit and building the payoff table.}
\end{enumerate}
...
\begin{enumerate}[label=\textbf{\alph*)}]
	\item
	\TaskHyperref{subsec:problem5-custom-printing-product-line-c1}
	{\textbf{(C1)} Interpreting decision alternatives, events, consequences, and states.}
	
	\item
	\TaskHyperref{subsec:problem5-custom-printing-product-line-c3}
	{\textbf{(C3)} Calculating profit and building the payoff table.}
\end{enumerate}
...
\begin{enumerate}[label=\textbf{\alph*)}]
	\item
	\TaskHyperref{subsec:problem6-event-equipment-fleet-c1}
	{\textbf{(C1)} Interpreting decision alternatives, events, consequences, and states.}
	
	\item
	\TaskHyperref{subsec:problem6-event-equipment-fleet-c3}
	{\textbf{(C3)} Calculating profit and building the payoff table.}
\end{enumerate}
...
\begin{enumerate}[label=\textbf{\alph*)}]
	\item
	\TaskHyperref{subsec:problem7-community-arts-sponsorship-c1}
	{\textbf{(C1)} Interpreting decision alternatives, events, consequences, and states.}
	
	\item
	\TaskHyperref{subsec:problem7-community-arts-sponsorship-c3}
	{\textbf{(C3)} Calculating profit and building the payoff table.}
\end{enumerate}
...
\begin{enumerate}[label=\textbf{\alph*)}]
	\item
	\TaskHyperref{subsec:problem8-distribution-contract-fulfilment-c1}
	{\textbf{(C1)} Interpreting decision alternatives, events, consequences, and states.}
	
	\item
	\TaskHyperref{subsec:problem8-distribution-contract-fulfilment-c3}
	{\textbf{(C3)} Calculating profit and building the payoff table.}
\end{enumerate}
...
\begin{center}
	...
	\begin{tabular}{cll}
		...
		\midrule
		9
		& \(R(A_i,S_j)=q(A_i,S_j)\bigl[r^A(A_i)+r^S(S_j)\bigr]\)
		...
		& \(C(A_i,S_j)=q(A_i,S_j)\bigl[c^A(A_i)+c^S(S_j)\bigr]\) \\
...
\begin{enumerate}[label=\textbf{\alph*)}]
	\item
	\TaskHyperref{subsec:problem9-farm-produce-subscription-c1}
	{\textbf{(C1)} Interpreting decision alternatives, events, consequences, and states.}
	
	\item
	\TaskHyperref{subsec:problem9-farm-produce-subscription-c3}
	{\textbf{(C3)} Calculating profit and building the payoff table.}
\end{enumerate}
...
\begin{enumerate}[label=\textbf{\alph*)}]
	\item
	\TaskHyperref{subsec:problem10-mobile-catering-configuration-c1}
	{\textbf{(C1)} Interpreting decision alternatives, events, consequences, and states.}
	
	\item
	\TaskHyperref{subsec:problem10-mobile-catering-configuration-c3}
	{\textbf{(C3)} Calculating profit and building the payoff table.}
\end{enumerate}
...
\begin{enumerate}[label=\textbf{\alph*)}]
	\item
	\TaskHyperref{subsec:problem11-online-training-programme-c1}
	{\textbf{(C1)} Interpreting decision alternatives, events, consequences, and states.}
	
	\item
	\TaskHyperref{subsec:problem11-online-training-programme-c3}
	{\textbf{(C3)} Calculating profit and building the payoff table.}
\end{enumerate}
...
\begin{enumerate}[label=\textbf{\alph*)}]
	\item
	\TaskHyperref{subsec:problem12-community-venue-membership-c1}
	{\textbf{(C1)} Interpreting decision alternatives, events, consequences, and states.}
	
	\item
	\TaskHyperref{subsec:problem12-community-venue-membership-c3}
	{\textbf{(C3)} Calculating profit and building the payoff table.}
\end{enumerate}
...
\begin{enumerate}[label=\textbf{\alph*)}]
	\item
	\TaskHyperref{subsec:problem13-urban-delivery-fleet-c1}
	{\textbf{(C1)} Interpreting decision alternatives, events, consequences, and states.}
	
	\item
	\TaskHyperref{subsec:problem13-urban-delivery-fleet-c3}
	{\textbf{(C3)} Calculating profit and building the payoff table.}
\end{enumerate}
...
\begin{enumerate}[label=\textbf{\alph*)}]
	\item
	\TaskHyperref{subsec:problem14-data-service-contract-c1}
	{\textbf{(C1)} Interpreting decision alternatives, events, consequences, and states.}
	
	\item
	\TaskHyperref{subsec:problem14-data-service-contract-c3}
	{\textbf{(C3)} Calculating profit and building the payoff table.}
\end{enumerate}
...
\begin{center}
	...
	\begin{tabular}{cll}
		...
		15
		& \(R(A_i,S_j)
		=q(A_i,S_j)\bigl[r^A(A_i)+r^S(S_j)\bigr]
		+F^{R,A}(A_i)\)
		& \(C(A_i,S_j)
		=q(A_i,S_j)\bigl[c^A(A_i)+c^S(S_j)\bigr]
		+F^{C,S}(S_j)\) \\
...
\begin{enumerate}[label=\textbf{\alph*)}]
	\item
	\TaskHyperref{subsec:problem15-regional-parcel-delivery-c1}
	{\textbf{(C1)} Interpreting decision alternatives, events, consequences, and states.}
	
	\item
	\TaskHyperref{subsec:problem15-regional-parcel-delivery-c3}
	{\textbf{(C3)} Calculating profit and building the payoff table.}
\end{enumerate}
...
\begin{enumerate}[label=\textbf{\alph*)}]
	\item
	\TaskHyperref{subsec:problem16-solar-installation-programme-c1}
	{\textbf{(C1)} Interpreting decision alternatives, events, consequences, and states.}
	
	\item
	\TaskHyperref{subsec:problem16-solar-installation-programme-c3}
	{\textbf{(C3)} Calculating profit and building the payoff table.}
\end{enumerate}
...
\begin{enumerate}[label=\textbf{\alph*)}]
	\item
	\TaskHyperref{subsec:problem17-hybrid-conference-production-c1}
	{\textbf{(C1)} Interpreting decision alternatives, events, consequences, and states.}
	
	\item
	\TaskHyperref{subsec:problem17-hybrid-conference-production-c3}
	{\textbf{(C3)} Calculating profit and building the payoff table.}
\end{enumerate}
...
\begin{enumerate}[label=\textbf{\alph*)}]
	\item
	\TaskHyperref{subsec:problem18-cold-storage-export-contract-c1}
	{\textbf{(C1)} Interpreting decision alternatives, events, consequences, and states.}
	
	\item
	\TaskHyperref{subsec:problem18-cold-storage-export-contract-c3}
	{\textbf{(C3)} Calculating profit and building the payoff table.}
\end{enumerate}
...
\begin{enumerate}[label=\textbf{\alph*)}]
	\item
	\TaskHyperref{subsec:problem19-smart-manufacturing-contract-c1}
	{\textbf{(C1)} Interpreting decision alternatives, events, consequences, and states.}
	
	\item
	\TaskHyperref{subsec:problem19-smart-manufacturing-contract-c3}
	{\textbf{(C3)} Calculating profit and building the payoff table.}
\end{enumerate}
...
\begin{enumerate}[label=\textbf{\alph*)}]
	\item
	\TaskHyperref{subsec:problem20-distribution-centre-automation-c1}
	{\textbf{(C1)} Interpreting decision alternatives, events, consequences, and states.}
	
	\item
	\TaskHyperref{subsec:problem20-distribution-centre-automation-c3}
	{\textbf{(C3)} Calculating profit and building the payoff table.}
\end{enumerate}
...
\begin{enumerate}[label=\textbf{\alph*)}]
	\item
	\TaskHyperref{subsec:problem21-electric-vehicle-charging-network-c1}
	{\textbf{(C1)} Interpreting decision alternatives, events, consequences, and states.}
	
	\item
	\TaskHyperref{subsec:problem21-electric-vehicle-charging-network-c3}
	{\textbf{(C3)} Calculating profit and building the payoff table.}
\end{enumerate}
