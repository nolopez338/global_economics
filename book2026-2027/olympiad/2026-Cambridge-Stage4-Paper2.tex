...
\begin{document}
	...
	\begin{tabular}{|M{0.95cm}|L{7.4cm}|M{1.05cm}|L{3.6cm}|L{5.2cm}|}
		...
		\hline
		\CellCenter{1.5cm}{2} &
		\CellCenter{1.5cm}{\begin{tikzpicture}[scale=1, every node/.style={font=\small, transform shape}]
			\node at (0,0) {889};
		...
		\begin{tabular}[t]{@{}l@{}}
			...
			\begin{tikzpicture}[scale=0.68, every node/.style={font=\small, transform shape}]
				\draw[line width=0.6pt]
				(0.7,0.1) .. controls (0.45,0.5) and (0.35,2.0) .. (0.25,4.0)
				-- (3.25,4.0)
				.. controls (3.15,2.0) and (3.05,0.5) .. (2.8,0.1)
				.. controls (2.2,-0.2) and (1.3,-0.2) .. (0.7,0.1);
				
				\draw[line width=0.6pt] (1.75,4.0) ellipse (1.55 and 0.18);
				\draw[line width=0.6pt] (0.25,4.0) -- (-0.25,3.65) -- (0.35,3.35);
				
				\draw[line width=0.6pt]
				(3.25,3.95) .. controls (4.05,4.10) and (4.05,3.70) .. (3.85,3.10)
				.. controls (3.65,2.35) and (3.55,1.85) .. (3.05,1.80);
				\draw[line width=0.6pt]
				(3.05,3.65) .. controls (3.55,3.70) and (3.55,3.35) .. (3.40,2.85)
				.. controls (3.25,2.35) and (3.20,2.15) .. (2.95,2.10);
				
				\draw[line width=0.5pt] (1.75,0.35) -- (1.75,3.75);
				\foreach \y in {0.95,1.55,2.15,2.75,3.35}
				\draw[line width=0.4pt] (1.75,\y) -- (1.95,\y);
				\node[anchor=west] at (1.85,3.65) {1000 ml};
				
				\draw[line width=0.8pt] (0.45,2.75) -- (3.05,2.75);
			\end{tikzpicture}
		\end{tabular}
		& \CellCenter{\QFourHeight}{1} &
		&
		...
		\CellCenter{1cm}{14} &
		\CellCenter{1cm}{\begin{tikzpicture}[scale=0.9, every node/.style={font=\small, transform shape}]
		...
		\CellCenter{\QFourHeight}{\begin{tikzpicture}[scale=0.72, every node/.style={font=\small, transform shape}]
		...
		\CellCenter{2.5cm}{\begin{tikzpicture}[scale=0.78, every node/.style={font=\small, transform shape}]
		...
		\CellCenter{3.5cm}{22 } &
		\CellCenter{3.5cm}{\begin{tikzpicture}[scale=0.38, every node/.style={font=\small, transform shape}]
