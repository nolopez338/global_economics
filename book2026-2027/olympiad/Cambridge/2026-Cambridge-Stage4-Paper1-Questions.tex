...
\begin{document}
	...
	\begin{multicols}{2}
		\begin{enumerate}[
			...
			\hfill \AnswerLine{\linewidth}
			
			\vspace{0.25cm}
			
			\hfill \AnswerLine{\linewidth} \QuestionMarks{1}
			...
			\begin{tabular}{@{}l@{\quad}r@{\hspace{0.55cm}}l@{\quad}r@{\hspace{0.55cm}}l@{\quad}r@{}}
			...
			\begin{tabular}{|>{\centering\arraybackslash}p{2.15cm}|>{\centering\arraybackslash}p{2.15cm}|>{\centering\arraybackslash}p{2.15cm}|}
				\hline
			...
			\hfill \AnswerLine{2.3cm}\quad and\quad \AnswerLine{2.3cm} \QuestionMarks{1}
			...
			\begin{array}{@{}c@{\qquad\qquad}c@{}}
				1 \div 6 = \dfrac{6}{1} & 1 \div 6 = \dfrac{1}{6} \\[0.7cm]
				6 \div 1 = \dfrac{6}{1} & 6 \div 1 = \dfrac{1}{6}
			\end{array}
			\]
			...
			\begin{center}
				\begin{tabular}{|>{\centering\arraybackslash}p{3.25cm}|>{\centering\arraybackslash}p{3.25cm}|}
					\hline
			...
			\AnswerLine{\linewidth} \QuestionMarks{1}
			...
			\begin{center}
				\begin{minipage}{0.9\linewidth}
					\centering
					`More children have music as a favourite hobby than reading.'
				\end{minipage}
			\end{center}
			...
			\[
			(\AnswerLine{1.2cm},\ \AnswerLine{1.2cm})
			\quad \text{and} \quad
			(\AnswerLine{1.2cm},\ \AnswerLine{1.2cm})
			\]
			\QuestionMarks{1}
