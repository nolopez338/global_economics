...
\begin{document}
	...
	\begin{center}
		...
		\begin{tabular}{|c|c|c|c|c|c|c|c|}
			\hline
			Test 1 & 10 & 18 & 13 & 6 & 8 & 5 & 12 \\ \hline
			Test 2 & 12 & 20 & 11 & 9 & 6 & 6 & 12 \\ \hline
		\end{tabular}
	\end{center}
	...
	\[
	\sum x^2 = 10^2+18^2+13^2+6^2+8^2+5^2+12^2
	\]
	\[
	=100+324+169+36+64+25+144 = 862
	\]
	
	\[
	\sum xy = (10)(12)+(18)(20)+(13)(11)+(6)(9)+(8)(6)+(5)(6)+(12)(12)
	\]
	\[
	=120+360+143+54+48+30+144 = 899
	\]
	...
	\[
	a=\frac{\frac{64600}{850}-\frac{59112}{850}}{7}
	=\frac{\frac{5488}{850}}{7}
	\]
	...
	\begin{center}
		\begin{tikzpicture}[x=0.45cm,y=0.4cm]
			\draw[->] (0,0) -- (19.5,0) node[right] {$x$};
			\draw[->] (0,0) -- (0,21.5) node[above] {$y$};
			
			\foreach \x/\y in {10/12,18/20,13/11,6/9,8/6,5/6,12/12}{
				\fill (\x,\y) circle (1.4pt);
			}
			
			\draw[thick] (5,5.752) -- (18,18.308);
			
			\node[font=\small] at (9.75,22.3) {Scatter plot and regression line};
		\end{tikzpicture}
	\end{center}
