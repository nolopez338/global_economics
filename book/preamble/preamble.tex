...
% When \SimpleSecIniciotrue is set, the icon is simplified to an arrow.
% Usage example: \secInicioIcon{links}
\newcommand{\secInicioIcon}[1]{%
...
% \secInicio
% \secInicio[target-label]
% Without an argument, links to the table of contents label "toc".
% With an argument, shows a link to the target and a separate link to "toc".
% Usage example: \secInicio
% Usage example: \secInicio[sec:inicio]
\newcommand{\secInicio}[1][]{%
	\begin{center}
		\ifstrempty{#1}{%
			\hyperref[toc]{\secInicioIcon{links}}%
		}{%
			\hyperref[#1]{\secInicioIcon{blue!70!black}}%
			\hspace{0.8em}%
			\hyperref[toc]{\secInicioIcon{links}}%
		}%
	\end{center}%
