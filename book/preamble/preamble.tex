...
% Without arguments, shows one upward links-color arrow that links to the table of contents label "toc".
% With one argument, shows two upward arrows: toc in links color and current-section in blue!70!black.
% With two arguments, also shows a downward blue!70!black arrow for the next-section link.
...
\NewDocumentCommand{\secInicio}{O{} O{}}{%
	\begin{center}
		\ifstrempty{#1}{%
			\hyperref[toc]{\secInicioIcon{links}{up}}%
		}{%
			\hyperref[toc]{\secInicioIcon{links}{up}}%
			\hspace{0.8em}%
