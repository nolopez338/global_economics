...
\]
\[
EV>0\Rightarrow 42p-7.5>0\Rightarrow p>\frac{5}{28}
\]
\[
0\le p\le0.75
\]
...
\]
\[
EV>0\Rightarrow 54p-10.2>0\Rightarrow p>\frac{17}{90}
\]
\[
0\le p\le0.70
\]
...
\]
\[
EV(A)>EV(B)\Rightarrow 34p+3>20p+8\Rightarrow p>\frac{5}{14}
\]
...
\]
\[
EV(A)=EV(B)\Rightarrow p=0.40,\quad EV(B)=EV(C)\Rightarrow p=0.225,\quad EV(A)=EV(C)\Rightarrow p=0.33
\]
\[
