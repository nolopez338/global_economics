...
\addcontentsline{toc}{section}{C7 Uses probabilities and expected value to analyze a decision-making problem.}
	...
	\begin{ExamProblems}
		...
		\item
		\section{Single Project under Uncertainty}
		...
		\item
		\section{Two Investment Alternatives}
		...
		\item
		\section{Three Production Plans}
		...
		\item
		\section{Two Alternatives with Three States}
		...
		\item
		\section{Policy Choice under Three States}
		...
		\item
		\section{New Service Platform Launch}
		...
		\item
		\section{Regional Store Opening}
		...
		\item
		\section{Marketing Strategy Choice}
		...
		\item
		\section{Investment Portfolio Selection}
