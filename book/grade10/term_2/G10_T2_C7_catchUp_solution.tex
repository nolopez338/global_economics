...
\addcontentsline{toc}{section}{C7 Uses probabilities and expected value to analyze a decision-making problem.}
...
\addcontentsline{toc}{subsection}{Problem 1 --- Single Project under Uncertainty}
...
\addcontentsline{toc}{subsection}{Problem 2 --- Technology Upgrade}
...
\addcontentsline{toc}{subsection}{Problem 3 --- Two Investment Alternatives}
...
\addcontentsline{toc}{subsection}{Problem 4 --- Three Production Plans}
...
\addcontentsline{toc}{subsection}{Problem 5 --- Two Alternatives with Three States}
...
\addcontentsline{toc}{subsection}{Problem 6 --- Policy Choice under Three States}
...
\addcontentsline{toc}{subsection}{Problem 7 --- New Service Platform Launch}
...
\addcontentsline{toc}{subsection}{Problem 8 --- Regional Store Opening}
...
\addcontentsline{toc}{subsection}{Problem 9 --- Marketing Strategy Choice}
...
\addcontentsline{toc}{subsection}{Problem 10 --- Investment Portfolio Selection}
...
\addcontentsline{toc}{section}{Minimal Solutions}
...
\]
\[
EV>0\Rightarrow 42p-7.5>0\Rightarrow p>\frac{5}{28}=0.179
\]
\[
0\le p\le0.75
\]
...
\]
\[
EV>0\Rightarrow 54p-10.2>0\Rightarrow p>\frac{17}{90}=0.189
\]
\[
0\le p\le0.70
\]
...
\]
\[
EV(A)>EV(B)\Rightarrow 34p+3>20p+8\Rightarrow p>\frac{5}{14}=0.357
\]

\subsection*{Problem 4}
\addcontentsline{toc}{subsection}{Problem 4}
\[
EV(A)=54p-2.8,\quad EV(B)=30p+6.8,\quad EV(C)=14p+10.4
\]
\[
EV(A)=EV(B)\Rightarrow p=0.40,\quad EV(B)=EV(C)\Rightarrow p=0.225,\quad EV(A)=EV(C)\Rightarrow p=\frac{11}{33}=0.333
\]
\[
0\le p<0.225:\ C\quad ;\quad p=0.225:\ B=C\quad ;\quad 0.225<p<0.40:\ B
\]
\[
p=0.40:\ A=B\quad ;\quad 0.40<p\le0.70:\ A
\]
...
\]
\[
EV(A)-EV(B)>0\Rightarrow 10p_1+3p_2>6
\]
\[
p_1\ge0,\ p_2\ge0,\ p_1+p_2\le1
\]
...
\]
\[
EV(A)-EV(B)>0\Rightarrow 11p_1+4p_2>7
\]

\subsection*{Problem 7}
\addcontentsline{toc}{subsection}{Problem 7}
\[
EV(A)=21.4,\quad EV(B)=20.0,\quad EV(C)=19.0
\]
\[
21.4>20.0>19.0\Rightarrow A
\]
...
\]
\[
EV>0\Rightarrow 14pq+34p+12q>16
\]
...
\]
\[
EV_A-EV_B>0\Rightarrow 5pq+3p>5
\]
...
\]
\[
EV_X-EV_Y>0\Rightarrow 3pq+p+2q>4
\]
