...
\addcontentsline{toc}{subsection}{2. Logistics Network Decision Under Demand and Cost Uncertainty}
...
\addcontentsline{toc}{subsection}{3. Holiday Inventory Plan Selection Under Expanded Demand Uncertainty}
...
\addcontentsline{toc}{subsection}{4. Routing System Choice Under Fuel and Congestion Uncertainty}
...
\addcontentsline{toc}{subsection}{5. Expected Value Comparison of Production Plans with Three States}
...
\addcontentsline{toc}{subsection}{6. Expected Value Comparison of Zoning Options with Three Alternatives}
