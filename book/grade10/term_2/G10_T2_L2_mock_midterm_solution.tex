...
\addcontentsline{toc}{section}{Problems}
	\begin{ExamProblems}
		...
		\item
		\section{Logistics Network Decision Under Demand and Cost Uncertainty}
		...
		\item
		\section{Holiday Inventory Plan Selection Under Expanded Demand Uncertainty}
		...
		\item
		\section{Expected Value Comparison of Production Plans with Three States}
		...
		\item
		\section{Expected Value Comparison of Zoning Options with Three Alternatives}
