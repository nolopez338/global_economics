...
\]
\[
\text{Recommended: } \text{Build the farm if } p>\frac{1}{5}
\]
...
\]
\[
\text{Recommended: } \text{Upgrade if } p>\frac{7}{23}
\]
...
\]
\[
\text{Recommended: } A \text{ if } p>\frac{4}{9};\ B \text{ if } p<\frac{4}{9}
\]
...
\]
\[
\text{Recommended: } C \text{ if } p<\frac{3}{7};\ B \text{ if } \frac{3}{7}<p<\frac{6}{13};\ A \text{ if } p>\frac{6}{13}
\]
