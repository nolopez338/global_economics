...
\begin{document}
	...
	\]
	\[
	M(\text{Plan A})=84,\quad M(\text{Plan B})=72
	\]
	\[
	\max\{M(\text{Plan A}),M(\text{Plan B})\}=84 \Rightarrow \text{Maximax choice: Plan A}
	\]
	\[
	M(\text{Mode A})=95,\quad M(\text{Mode B})=88
	\]
	\[
	\max\{M(\text{Mode A}),M(\text{Mode B})\}=95 \Rightarrow \text{Maximax choice: Mode A}
	\]
	\[
	M(\text{Strategy A})=120,\quad M(\text{Strategy B})=108,\quad M(\text{Strategy C})=96
	\]
	\[
	\max\{M(\text{Strategy A}),M(\text{Strategy B}),M(\text{Strategy C})\}=120 \Rightarrow \text{Maximax choice: Strategy A}
	\]
	\[
	M(\text{Policy A})=74,\quad M(\text{Policy B})=82,\quad M(\text{Policy C})=86
	\]
	\[
	\max\{M(\text{Policy A}),M(\text{Policy B}),M(\text{Policy C})\}=86 \Rightarrow \text{Maximax choice: Policy C}
	\]
	\[
	M(\text{Format A})=150,\quad M(\text{Format B})=132,\quad M(\text{Format C})=144,\quad M(\text{Format D})=120
	\]
	\[
	\max\{M(\text{Format A}),M(\text{Format B}),M(\text{Format C}),M(\text{Format D})\}=150 \Rightarrow \text{Maximax choice: Format A}
	\]
	\[
	M(\text{Contract A})=160,\quad M(\text{Contract B})=152,\quad M(\text{Contract C})=146,\quad M(\text{Contract D})=132
	\]
	\[
	\max\{M(\text{Contract A}),M(\text{Contract B}),M(\text{Contract C}),M(\text{Contract D})\}=160 \Rightarrow \text{Maximax choice: Contract A}
	\]
	\[
	M(\text{Plan A})=190,\quad M(\text{Plan B})=182,\quad M(\text{Plan C})=176,\quad M(\text{Plan D})=168,\quad M(\text{Plan E})=156
	\]
	\[
	\max\{M(\text{Plan A}),M(\text{Plan B}),M(\text{Plan C}),M(\text{Plan D}),M(\text{Plan E})\}=190 \Rightarrow \text{Maximax choice: Plan A}
	\]
	\[
	M(\text{Package A})=220,\quad M(\text{Package B})=210,\quad M(\text{Package C})=204,\quad M(\text{Package D})=196,\quad M(\text{Package E})=186
	\]
	\[
	\max\{M(\text{Package A}),M(\text{Package B}),M(\text{Package C}),M(\text{Package D}),M(\text{Package E})\}=220 \Rightarrow \text{Maximax choice: Package A}
	\]
	\[
	M(\text{Design A})=260,\quad M(\text{Design B})=248,\quad M(\text{Design C})=242,\quad M(\text{Design D})=234,\quad M(\text{Design E})=226,\quad M(\text{Design F})=214
	\]
	\[
	\max\{M(\text{Design A}),M(\text{Design B}),M(\text{Design C}),M(\text{Design D}),M(\text{Design E}),M(\text{Design F})\}=260 \Rightarrow \text{Maximax choice: Design A}
	\]
\end{document}
