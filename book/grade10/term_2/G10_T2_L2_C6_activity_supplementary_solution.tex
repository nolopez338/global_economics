...
\addcontentsline{toc}{subsection}{1. School cafeteria supply strategy under uncertain demand}
...
\addcontentsline{toc}{subsection}{2. Holiday bookstore inventory strategy choice}
...
\addcontentsline{toc}{subsection}{3. Battery storage contract selection for dry season demand}
...
\addcontentsline{toc}{subsection}{4. Saturday program planning for community sports attendance}
...
\addcontentsline{toc}{subsection}{5. City recycling outreach strategy under variable response}
...
\addcontentsline{toc}{subsection}{6. Vacation package allocation for coastal tourism demand}
...
\addcontentsline{toc}{subsection}{7. Regional bus fleet scheduling under demand uncertainty}
