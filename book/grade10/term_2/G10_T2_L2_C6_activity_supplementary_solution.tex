...
\addcontentsline{toc}{subsection}{School cafeteria supply strategy under uncertain demand}
...
\addcontentsline{toc}{subsection}{Holiday bookstore inventory strategy choice}
...
\addcontentsline{toc}{subsection}{Battery storage contract selection for dry season demand}
...
\addcontentsline{toc}{subsection}{Saturday program planning for community sports attendance}
...
\addcontentsline{toc}{subsection}{City recycling outreach strategy under variable response}
...
\addcontentsline{toc}{subsection}{Vacation package allocation for coastal tourism demand}
...
\addcontentsline{toc}{subsection}{Regional bus fleet scheduling under demand uncertainty}
