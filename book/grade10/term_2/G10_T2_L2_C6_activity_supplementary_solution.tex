...
\addcontentsline{toc}{section}{Problems}
	\begin{ExamProblems}
		\item
		\section{School cafeteria supply strategy under uncertain demand}
		...
		\item
		\section{Holiday bookstore inventory strategy choice}
		...
		\item
		\section{Battery storage contract selection for dry season demand}
		...
		\item
		\section{Saturday program planning for community sports attendance}
		...
		\item
		\section{City recycling outreach strategy under variable response}
		...
		\item
		\section{Vacation package allocation for coastal tourism demand}
		...
		\item
		\section{Regional bus fleet scheduling under demand uncertainty}
