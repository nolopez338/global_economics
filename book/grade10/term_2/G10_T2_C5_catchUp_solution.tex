...
\begin{enumerate}
	...
	\[
	\begin{aligned}
	m(\text{Strategy A}) &= \min\{120,86,44\}=44,\\
	m(\text{Strategy B}) &= \min\{108,92,58\}=58,\\
	m(\text{Strategy C}) &= \min\{96,88,70\}=70
	\end{aligned}
	\]
	\[
	\begin{aligned}
	\max\{m(\text{Strategy A}),m(\text{Strategy B}),m(\text{Strategy C})\} &= 70\\
	&\Rightarrow\;\text{Maximin choice: Strategy C}
	\end{aligned}
	\]
	\item
	\[
	\begin{aligned}
	m(\text{Policy A}) &= \min\{74,68,36,8\}=8,\\
	m(\text{Policy B}) &= \min\{82,76,50,24\}=24,\\
	m(\text{Policy C}) &= \min\{86,78,58,34\}=34
	\end{aligned}
	\]
	\[
	\begin{aligned}
	\max\{m(\text{Policy A}),m(\text{Policy B}),m(\text{Policy C})\} &= 34\\
	&\Rightarrow\;\text{Maximin choice: Policy C}
	\end{aligned}
	\]
	\item
	\[
	\begin{aligned}
	m(\text{Format A}) &= \min\{150,110,72,30\}=30,\\
	m(\text{Format B}) &= \min\{132,118,82,48\}=48,\\
	m(\text{Format C}) &= \min\{144,124,94,62\}=62,\\
	m(\text{Format D}) &= \min\{120,108,88,66\}=66
	\end{aligned}
	\]
	\[
	\begin{aligned}
	\max\{m(\text{Format A}),m(\text{Format B}),m(\text{Format C}),m(\text{Format D})\} &= 66\\
	&\Rightarrow\;\text{Maximin choice: Format D}
	\end{aligned}
	\]
	\item
	\[
	\begin{aligned}
	m(\text{Contract A}) &= \min\{160,138,102,66,24\}=24,\\
	m(\text{Contract B}) &= \min\{152,140,114,80,40\}=40,\\
	m(\text{Contract C}) &= \min\{146,136,120,92,54\}=54,\\
	m(\text{Contract D}) &= \min\{132,126,116,98,70\}=70
	\end{aligned}
	\]
	\[
	\begin{aligned}
	\max\{m(\text{Contract A}),m(\text{Contract B}),m(\text{Contract C}),m(\text{Contract D})\} &= 70\\
	&\Rightarrow\;\text{Maximin choice: Contract D}
	\end{aligned}
	\]
	\item
	\[
	\begin{aligned}
	m(\text{Plan A}) &= \min\{190,150,108,58,12\}=12,\\
	m(\text{Plan B}) &= \min\{182,154,120,76,34\}=34,\\
	m(\text{Plan C}) &= \min\{176,152,128,90,52\}=52,\\
	m(\text{Plan D}) &= \min\{168,146,126,98,64\}=64,\\
	m(\text{Plan E}) &= \min\{156,140,124,104,76\}=76
	\end{aligned}
	\]
	\[
	\begin{aligned}
	\max\{m(\text{Plan A}),m(\text{Plan B}),m(\text{Plan C}),\\
	\qquad m(\text{Plan D}),m(\text{Plan E})\} &= 76\\
	&\Rightarrow\;\text{Maximin choice: Plan E}
	\end{aligned}
	\]
	\item
	\[
	\begin{aligned}
	m(\text{Package A}) &= \min\{220,184,142,96,58,22\}=22,\\
	m(\text{Package B}) &= \min\{210,186,152,110,74,40\}=40,\\
	m(\text{Package C}) &= \min\{204,182,158,122,88,54\}=54,\\
	m(\text{Package D}) &= \min\{196,176,156,128,98,68\}=68,\\
	m(\text{Package E}) &= \min\{186,170,152,130,106,82\}=82
	\end{aligned}
	\]
	\[
	\begin{aligned}
	\max\{m(\text{Package A}),m(\text{Package B}),m(\text{Package C}),\\
	\qquad m(\text{Package D}),m(\text{Package E})\} &= 82\\
	&\Rightarrow\;\text{Maximin choice: Package E}
	\end{aligned}
	\]
	\item
	\[
	\begin{aligned}
	m(\text{Design A}) &= \min\{260,220,170,118,70,136\}=70,\\
	m(\text{Design B}) &= \min\{248,222,182,132,86,148\}=86,\\
	m(\text{Design C}) &= \min\{242,218,188,146,102,158\}=102,\\
	m(\text{Design D}) &= \min\{234,212,190,156,118,164\}=118,\\
	m(\text{Design E}) &= \min\{226,206,188,162,130,168\}=130
	\end{aligned}
	\]
	\[
	\begin{aligned}
	\max\{m(\text{Design A}),m(\text{Design B}),m(\text{Design C}),\\
	\qquad m(\text{Design D}),m(\text{Design E})\} &= 130\\
	&\Rightarrow\;\text{Maximin choice: Design E}
	\end{aligned}
	\]
\end{enumerate}
