...
\addcontentsline{toc}{section}{Solutions Summary}
\begin{enumerate}
	\item
	\[
	...
	\item
	\[
	m(A)=\min\{84,22\}=22,\quad m(B)=\min\{72,34\}=34
	\]
	\[
	\max\{m(A),m(B)\}=34\;\Rightarrow\;\text{Maximin choice: B}
	\]
	\item
	\[
	m(A)=\min\{95,60,18\}=18,\quad m(B)=\min\{88,66,30\}=30
	\]
	\[
	\max\{m(A),m(B)\}=30\;\Rightarrow\;\text{Maximin choice: B}
	\]
	\item
	\[
	\begin{aligned}
	m(A) &= \min\{120,86,44\}=44,\\
	m(B) &= \min\{108,92,58\}=58,\\
	m(C) &= \min\{96,88,70\}=70
	\end{aligned}
	\]
	\[
	\begin{aligned}
	\max\{m(A),m(B),m(C)\} &= 70\\
	&\Rightarrow\;\text{Maximin choice: C}
	\end{aligned}
	\]
	\item
	\[
	\begin{aligned}
	m(A) &= \min\{74,68,36,8\}=8,\\
	m(B) &= \min\{82,76,50,24\}=24,\\
	m(C) &= \min\{86,78,58,34\}=34
	\end{aligned}
	\]
	\[
	\begin{aligned}
	...
	\[
	\begin{aligned}
	m(A) &= \min\{150,110,72,30\}=30,\\
	m(B) &= \min\{132,118,82,48\}=48,\\
	m(C) &= \min\{144,124,94,62\}=62,\\
	m(D) &= \min\{120,108,88,66\}=66
	\end{aligned}
	\]
	\[
	\begin{aligned}
	\max\{m(A),m(B),m(C),m(D)\} &= 66\\
	&\Rightarrow\;\text{Maximin choice: D}
	\end{aligned}
	\]
	\item
	\[
	\begin{aligned}
	m(A) &= \min\{160,138,102,66,24\}=24,\\
	m(B) &= \min\{152,140,114,80,40\}=40,\\
	m(C) &= \min\{146,136,120,92,54\}=54,\\
	m(D) &= \min\{132,126,116,98,70\}=70
	\end{aligned}
	\]
	\[
	\begin{aligned}
	\max\{m(A),m(B),m(C),m(D)\} &= 70\\
	&\Rightarrow\;\text{Maximin choice: D}
	\end{aligned}
	\]
	\item
	\[
	\begin{aligned}
	m(A) &= \min\{190,150,108,58,12\}=12,\\
	m(B) &= \min\{182,154,120,76,34\}=34,\\
	m(C) &= \min\{176,152,128,90,52\}=52,\\
	m(D) &= \min\{168,146,126,98,64\}=64,\\
	m(E) &= \min\{156,140,124,104,76\}=76
	\end{aligned}
	\]
	\[
	\begin{aligned}
	\max\{m(A),m(B),m(C),\\
	\qquad m(D),m(E)\} &= 76\\
	&\Rightarrow\;\text{Maximin choice: E}
	\end{aligned}
	\]
	\item
	\[
	\begin{aligned}
	m(A) &= \min\{220,184,142,96,58,22\}=22,\\
	m(B) &= \min\{210,186,152,110,74,40\}=40,\\
	m(C) &= \min\{204,182,158,122,88,54\}=54,\\
	m(D) &= \min\{196,176,156,128,98,68\}=68,\\
	m(E) &= \min\{186,170,152,130,106,82\}=82
	\end{aligned}
	\]
	\[
	\begin{aligned}
	...
	\[
	\begin{aligned}
	m(A) &= \min\{260,220,170,118,70,136\}=70,\\
	m(B) &= \min\{248,222,182,132,86,148\}=86,\\
	m(C) &= \min\{242,218,188,146,102,158\}=102,\\
	m(D) &= \min\{234,212,190,156,118,164\}=118,\\
	m(E) &= \min\{226,206,188,162,130,168\}=130
	\end{aligned}
	\]
	\[
	\begin{aligned}
