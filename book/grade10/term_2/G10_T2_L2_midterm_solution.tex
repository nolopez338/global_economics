...
\addcontentsline{toc}{subsection}{1. Bakery Product Bundle Selection Under Multiple Demand Levels}
...
\addcontentsline{toc}{subsection}{3. Shipping Hub Decision Under Demand and Cost Uncertainty}
...
\addcontentsline{toc}{subsection}{4. Community Theater Ticketing Strategy Under Demand Uncertainty}
...
\addcontentsline{toc}{subsection}{5. Holiday Inventory Plan Selection Under Demand Uncertainty}
...
\addcontentsline{toc}{subsection}{6. Routing System Choice Under Fuel and Congestion Uncertainty}
...
\addcontentsline{toc}{subsection}{7. Expected Value Comparison of Marketing Options}
...
\addcontentsline{toc}{subsection}{8. Expected Value Comparison of Production Plans}
...
\addcontentsline{toc}{subsection}{9. Expected Value Comparison of Zoning Options}
