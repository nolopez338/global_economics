...
\addcontentsline{toc}{section}{Problems}
	\begin{ExamProblems}
		\item
		\section{Bakery Product Bundle Selection Under Multiple Demand Levels}
		...
		\item
		\section{Shipping Hub Decision Under Demand and Cost Uncertainty}
		...
		\item
		\section{Community Theater Ticketing Strategy Under Demand Uncertainty}
		...
		\item
		\section{Holiday Inventory Plan Selection Under Demand Uncertainty}
		...
		\item
		\section{Routing System Choice Under Fuel and Congestion Uncertainty}
		...
		\item
		\section{Expected Value Comparison of Marketing Options}
		...
		\item
		\section{Expected Value Comparison of Production Plans}
		...
		\item
		\section{Expected Value Comparison of Zoning Options}
