...
\newcommand{\UniformProbGraph}[5]{
\begin{center}
\begin{tikzpicture}
\pgfmathsetmacro{\supportA}{#1}
\pgfmathsetmacro{\supportB}{#2}
\pgfmathsetmacro{\heightVal}{1/(\supportB-\supportA)}
...
\addplot[domain=#1:#2, samples=2, draw=none, fill=blue!20, fill opacity=0.35] {\heightVal} \closedcycle;
\addplot[domain=#4:#5, samples=2, draw=none, fill=blue!60, fill opacity=0.55] {\heightVal} \closedcycle;
\addplot[smooth, domain=#1:#2, samples=2] {\heightVal};
\end{axis}
\end{tikzpicture}
\end{center}
}

\newcommand{\UniformProbGraphTwoIntervals}[6]{
\begin{center}
\begin{tikzpicture}
\pgfmathsetmacro{\supportA}{#1}
\pgfmathsetmacro{\supportB}{#2}
...
\addplot[domain=#1:#2, samples=2, draw=none, fill=blue!20, fill opacity=0.35] {\heightVal} \closedcycle;
\addplot[domain=#3:#4, samples=2, draw=none, fill=blue!60, fill opacity=0.55] {\heightVal} \closedcycle;
\addplot[domain=#5:#6, samples=2, draw=none, fill=blue!60, fill opacity=0.55] {\heightVal} \closedcycle;
\addplot[smooth, domain=#1:#2, samples=2] {\heightVal};
\end{axis}
\end{tikzpicture}
\end{center}
...
This means all values in $[a,b]$ are equally likely.
Take numbers $c,d$ such that $a\le c\le d\le b$, and numbers $e,f$ such that $a\le e<f\le b$.

\textbf{Question.}
Find:
\begin{itemize}
    \item[(a)] $P(c\le X\le d)$,
    \item[(b)] $P(X<e\ \text{or}\ X>f)$.
Explain the general method you used.
\end{itemize}

\textbf{Solution.}
For a uniform random variable on $[a,b]$, the total interval length is
\[
b-a.
\]
So each probability is found by
\[
P(\text{event})=\frac{\text{length of event interval(s)}}{b-a}.
\]
Therefore,
\[
P(c\le X\le d)=\frac{d-c}{b-a}.
\]
\UniformProbGraph{0}{1}{0}{0.25}{0.7}
For two outside pieces,
\[
P(X<e\ \text{or}\ X>f)=\frac{e-a}{b-a}+\frac{b-f}{b-a}=1-\frac{f-e}{b-a}.
\]
\UniformProbGraphTwoIntervals{0}{1}{0}{0.2}{0.8}{1}

\textbf{Interpretation.}
In a uniform model, probability is proportional to interval length.
So we compare the length of the requested region(s) to the full support length.

% --------------------------------------------------

\item
\section{Bus Stop Waiting Time}
...
\]
\UniformProbGraph{0}{12}{0}{0}{5}
\[
P(3\le X\le 9)=\frac{9-3}{12}=\frac{6}{12}=\frac{1}{2}=0.5.
\]
\UniformProbGraph{0}{12}{0}{3}{9}
...
\]
\UniformProbGraph{2}{10}{0}{4}{7}
\[
P(X>8)=\frac{10-8}{8}=\frac{2}{8}=\frac{1}{4}=0.25.
\]
\UniformProbGraph{2}{10}{0}{8}{10}
...
\item
\section{Morning Temperature Range}
...
\item
\section{Delivery Arrival Minute}
...
\item
\section{Practice Session Length}
...
\]
\UniformProbGraph{30}{90}{0}{30}{50}
\[
P(45\le X\le 75)=\frac{75-45}{60}=\frac{30}{60}=\frac{1}{2}=0.5.
\]
\UniformProbGraph{30}{90}{0}{45}{75}
...
\item
\section{Commute Time with Complement}
...
\]
\UniformProbGraph{5}{25}{0}{10}{20}
Using complement:
\[
P(X<10\ \text{or}\ X>20)=1-P(10\le X\le 20)=1-\frac{1}{2}=\frac{1}{2}.
\]
\UniformProbGraphTwoIntervals{5}{25}{5}{10}{20}{25}
...
\item
\section{Online Game Match Duration}
...
\]
\UniformProbGraph{40}{70}{0}{55}{70}
\[
P(45\le X\le 60)=\frac{60-45}{30}=\frac{15}{30}=\frac{1}{2}=0.5.
\]
\UniformProbGraph{40}{70}{0}{45}{60}
...
\item
\section{Daily Minimum Temperature}
...
\item
\section{Video Call Start Minute}
...
\]
\UniformProbGraph{0}{15}{0}{12}{15}
\[
P(4\le X\le 10)=\frac{10-4}{15}=\frac{6}{15}=\frac{2}{5}=0.4.
\]
\UniformProbGraph{0}{15}{0}{4}{10}
