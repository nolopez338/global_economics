...
\begin{document}
	...
	\subsection*{1. Automatic Savings Transfers}
	\addcontentsline{toc}{subsection}{1. Automatic Savings Transfers}
	...
	\subsection*{Private Accident Insurance Adoption}
	\addcontentsline{toc}{subsection}{2. Private Accident Insurance Adoption}
	\subsection*{Problem description}
	...
	\subsection*{Credit Card Balance Repayment}
	\addcontentsline{toc}{subsection}{3. Credit Card Balance Repayment}
	\subsection*{Problem description}
	...
	\subsection*{Monthly Investing Benchmark}
	\addcontentsline{toc}{subsection}{4. Monthly Investing Benchmark}
	\subsection*{Problem description}
	...
	\subsection*{Emergency Fund Comparison}
	\addcontentsline{toc}{subsection}{5. Emergency Fund Comparison}
	\subsection*{Problem description}
	...
	\subsection*{Retirement Savings by Work Sector}
	\addcontentsline{toc}{subsection}{6. Retirement Savings by Work Sector}
	\subsection*{Problem description}
	...
	\subsection*{Budgeting Rule Use by City}
	\addcontentsline{toc}{subsection}{7. Budgeting Rule Use by City}
	\subsection*{Problem description}
	...
	\subsection*{ETF Adoption Across Two Periods}
	\addcontentsline{toc}{subsection}{8. ETF Adoption Across Two Periods}
	\subsection*{Problem description}
	...
	\subsection*{Debt-Management Training Channels}
	\addcontentsline{toc}{subsection}{9. Debt-Management Training Channels}
	\subsection*{Problem description}
	...
	\subsection*{Savings Habit Program Retention}
	\addcontentsline{toc}{subsection}{10. Savings Habit Program Retention}
	\subsection*{Problem description}
	...
	\]
	\[
	E_{90}=0.0579,\quad E_{95}=0.0690,\quad E_{99}=0.0907
	\]
	\[
	\text{CI}_{90\%}=[0.402,\,0.518],\quad \text{CI}_{95\%}=[0.391,\,0.529],\quad \text{CI}_{99\%}=[0.369,\,0.551]
	\]
	...
	\]
	\[
	\text{CI}_{98\%}=[0.476,\,0.606]
	\]
	
	\subsection*{Problem 5}
	\textbf{Group A}
	\[
	\hat p_A=0.68,\quad E_A=0.0577
	\]
	\[
	\text{CI}_{A,95\%}=[0.622,\,0.738]
	\]
	
	\textbf{Group B}
	\[
	\hat p_B=0.568,\quad E_B=0.0613
	\]
	\[
	\text{CI}_{B,95\%}=[0.507,\,0.629]
	\]
	
	\subsection*{Problem 6}
	\textbf{Sector 1}
	\[
	\hat p_1=0.42,\quad E_1=0.0469
	\]
	\[
	\text{CI}_{1,90\%}=[0.373,\,0.467]
	\]
	
	\textbf{Sector 2}
	\[
	\hat p_2=0.5393,\quad E_2=0.0490
	\]
	\[
	\text{CI}_{2,90\%}=[0.490,\,0.588]
	\]
	
	\subsection*{Problem 7}
	\textbf{City A}
	\[
	\hat p_A=0.55,\quad E_{A,90}=0.0431,\quad E_{A,95}=0.0514
	\]
	\[
	\text{CI}_{A,90\%}=[0.507,\,0.593],\quad \text{CI}_{A,95\%}=[0.499,\,0.601]
	\]
	
	\textbf{City B}
	\[
	\hat p_B=0.50,\quad E_{B,90}=0.0446,\quad E_{B,95}=0.0531
	\]
	\[
	\text{CI}_{B,90\%}=[0.455,\,0.545],\quad \text{CI}_{B,95\%}=[0.447,\,0.553]
	\]
	
	\subsection*{Problem 8}
	\textbf{Period 1}
	\[
	\hat p_1=0.55,\quad E_1=0.0476
	\]
	\[
	\text{CI}_{1,95\%}=[0.502,\,0.598]
	\]
	...
	\textbf{Period 2}
	\[
	\hat p_2=0.6195,\quad E_2=0.0470
	\]
	\[
	\text{CI}_{2,95\%}=[0.573,\,0.666]
	\]
	...
	\textbf{Channel A}
	\[
	\hat p_A=0.60,\quad E_{A,90}=0.0482,\quad E_{A,99}=0.0755
	\]
	\[
	\text{CI}_{A,90\%}=[0.552,\,0.648],\quad \text{CI}_{A,99\%}=[0.524,\,0.676]
	\]
	
	\textbf{Channel B}
	\[
	\hat p_B=0.57,\quad E_{B,90}=0.0470,\quad E_{B,99}=0.0736
	\]
	\[
	\text{CI}_{B,90\%}=[0.523,\,0.617],\quad \text{CI}_{B,99\%}=[0.496,\,0.644]
	\]
	
	\textbf{Channel C}
	\[
	\hat p_C=0.50,\quad E_{C,90}=0.0510,\quad E_{C,99}=0.0799
	\]
	\[
	\text{CI}_{C,90\%}=[0.449,\,0.551],\quad \text{CI}_{C,99\%}=[0.420,\,0.580]
	\]
	
	\subsection*{Problem 10}
	\textbf{Program X}
	\[
	\hat p_X=0.6314,\quad E_{X,95}=0.0506,\quad E_{X,99}=0.0665
	\]
	\[
	\text{CI}_{X,95\%}=[0.581,\,0.682],\quad \text{CI}_{X,99\%}=[0.565,\,0.698]
	\]
	
	\textbf{Program Y}
	\[
	\hat p_Y=0.5788,\quad E_{Y,95}=0.0533,\quad E_{Y,99}=0.0701
	\]
	\[
	\text{CI}_{Y,95\%}=[0.525,\,0.632],\quad \text{CI}_{Y,99\%}=[0.509,\,0.649]
	\]
	
	\textbf{Program Z}
	\[
	\hat p_Z=0.5294,\quad E_{Z,95}=0.0531,\quad E_{Z,99}=0.0698
	\]
	\[
	\text{CI}_{Z,95\%}=[0.476,\,0.582],\quad \text{CI}_{Z,99\%}=[0.460,\,0.599]
	\]
