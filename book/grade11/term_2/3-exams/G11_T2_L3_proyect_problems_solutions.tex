...
\addcontentsline{toc}{section}{C9: Confidence interval for the mean when variance is unknown}
	\begin{ExamProblems}
		\item
		\textbf{1. Driver payouts in ride-sharing}\\
		...
		\newpage
		\item
		\textbf{2. Platform fees for investment app users}\\
		...
		\newpage
		\item
		\textbf{3. Weekday-morning order values}\\
		...
		\newpage
		\item
		\textbf{4. Same-city delivery time classes}\\
		...
		\newpage
		\item
		\textbf{5. Daily ad spending classes}\\
		...
		\newpage
		\item
		\textbf{6. Monthly recurring revenue classes}\\
		...
		\newpage
		\item
		\textbf{7. Monthly account balance classes}\\
		...
		\newpage
		\item
		\textbf{8. Annual instructor earnings classes}\\
		...
		\newpage
		\item
		\textbf{9. Monthly seller revenue classes}\\
		...
		\newpage
		\item
		\textbf{10. Quarterly creator revenue classes}\\
