...
\addcontentsline{toc}{section}{Problems}
	\begin{ExamProblems}
		\item
		\section{Problem 1}
		\section{Downtown Listing Mean Estimate}
		...
		\item
		\section{Problem 2}
		\section{Designer Income Mean Estimate}
		...
		\item
		\section{Problem 3}
		\section{Courier Earnings Mean Comparison}
		...
		\item
		\section{Problem 4}
		\section{Credit Card Full-Payment Rate}
		...
		\item
		\section{Problem 5}
		\section{Positive Return Proportion Estimate}
		...
		\item
		\section{Problem 6}
		\section{Student Loan Repayment Comparison}
		...
		\item
		\section{Problem 7}
		\section{Employee Cost of Living}
		...
		\item
		\section{Problem 8}
		\section{Micro-Shop Revenue Mean}
		...
		\item
		\section{Problem 9}
		\section{Subscription Spending Mean Estimate}
		...
		\item
		\section{Problem 10}
		\section{Branch Commission Mean Comparison}
