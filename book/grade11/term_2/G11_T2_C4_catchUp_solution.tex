...
\addcontentsline{toc}{subsection}{Downtown Listing Mean Estimate}
...
\addcontentsline{toc}{subsection}{Designer Income Mean Estimate}
...
\addcontentsline{toc}{subsection}{Courier Earnings Mean Comparison}
...
\addcontentsline{toc}{subsection}{Credit Card Full-Payment Rate}
...
\addcontentsline{toc}{subsection}{Positive Return Proportion Estimate}
...
\addcontentsline{toc}{subsection}{Student Loan Repayment Comparison}
...
\addcontentsline{toc}{subsection}{Employee Cost of Living}
...
\addcontentsline{toc}{subsection}{Micro-Shop Revenue Mean}
...
\addcontentsline{toc}{subsection}{Subscription Spending Mean Estimate}
...
\addcontentsline{toc}{subsection}{Branch Commission Mean Comparison}
