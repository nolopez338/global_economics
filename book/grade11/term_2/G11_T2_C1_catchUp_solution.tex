...
\addcontentsline{toc}{subsection}{Digital Studio Weekly Payouts}
...
\addcontentsline{toc}{subsection}{Income Channel Volatility Comparison}
...
\addcontentsline{toc}{subsection}{Referral Bonus Dispersion Analysis}
...
\addcontentsline{toc}{subsection}{Delivery Route Tip Volatility}
...
\addcontentsline{toc}{subsection}{Subscription Earnings Dispersion}
...
\addcontentsline{toc}{subsection}{Portfolio Strategy Stability Comparison}
...
\addcontentsline{toc}{subsection}{Planner Sales Outlier Impact}
...
\addcontentsline{toc}{subsection}{Streamer Income Outlier Impact}
...
\addcontentsline{toc}{subsection}{Late Payment Probability Variability}
...
\addcontentsline{toc}{subsection}{Sale Probability Variability}
