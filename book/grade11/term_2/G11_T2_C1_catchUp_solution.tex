...
\addcontentsline{toc}{subsection}{2. Digital Studio Weekly Payouts}
...
\addcontentsline{toc}{subsection}{4. Income Channel Volatility Comparison}
...
\addcontentsline{toc}{subsection}{6. Referral Bonus Dispersion Analysis}
...
\addcontentsline{toc}{subsection}{8. Delivery Route Tip Volatility}
...
\addcontentsline{toc}{subsection}{10. Subscription Earnings Dispersion}
...
\addcontentsline{toc}{subsection}{12. Portfolio Strategy Stability Comparison}
...
\addcontentsline{toc}{subsection}{14. Planner Sales Outlier Impact}
...
\addcontentsline{toc}{subsection}{16. Streamer Income Outlier Impact}
...
\addcontentsline{toc}{subsection}{18. Late Payment Probability Variability}
...
\addcontentsline{toc}{subsection}{20. Sale Probability Variability}
...
\subsection*{Problem 1}
\[
\bar{x}=130.93,\quad s=8.06
\]

\subsection*{Problem 2}
\[
\bar{x}_A=75.90,\quad s_A=13.02,\quad \bar{x}_B=59.36,\quad s_B=3.23
\]

\subsection*{Problem 3}
\[
\bar{x}=15.43,\quad s=4.78
\]

\subsection*{Problem 4}
\[
\bar{x}_A=14.60,\quad s_A=4.90,\quad \bar{x}_B=11.60,\quad s_B=5.07
\]

\subsection*{Problem 5}
\[
\bar{x}=87.00,\quad s=23.08
\]

\subsection*{Problem 6}
\[
\bar{x}_A=64.50,\quad s_A=22.36,\quad \bar{x}_B=62.50,\quad s_B=24.52
\]

\subsection*{Problem 7}
\[
\bar{x}=101.50,\quad s=36.20
\]

\subsection*{Problem 8}
\[
\bar{x}=77.27,\quad s=37.15
\]

\subsection*{Problem 9}
\[
\bar{x}=0.15,\quad s=0.04
\]

\subsection*{Problem 10}
\[
\bar{x}=0.31,\quad s=0.03
\]
