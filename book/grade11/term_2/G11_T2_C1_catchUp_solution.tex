...
\addcontentsline{toc}{section}{Problems}
	\begin{ExamProblems}
		\item
		\section{Problem 1}
		\section{Digital Studio Weekly Payouts}
		...
		\item
		\section{Problem 2}
		\section{Income Channel Volatility Comparison}
		...
		\item
		\section{Problem 3}
		\section{Referral Bonus Dispersion Analysis}
		...
		\item
		\section{Problem 4}
		\section{Delivery Route Tip Volatility}
		...
		\item
		\section{Problem 5}
		\section{Subscription Earnings Dispersion}
		...
		\item
		\section{Problem 6}
		\section{Portfolio Strategy Stability Comparison}
		...
		\item
		\section{Problem 7}
		\section{Planner Sales Outlier Impact}
		...
		\item
		\section{Problem 8}
		\section{Streamer Income Outlier Impact}
		...
		\item
		\section{Problem 9}
		\section{Late Payment Probability Variability}
		...
		\item
		\section{Problem 10}
		\section{Sale Probability Variability}
