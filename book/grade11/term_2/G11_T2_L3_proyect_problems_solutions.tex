...
\addcontentsline{toc}{subsubsection}{C8: Confidence Interval (t-statistic)}
		\[
...
\addcontentsline{toc}{subsubsection}{C5: Confidence Interval (z-statistic)}
		\[
		z^*=z_{0.025}=1.960
		\]
...
\addcontentsline{toc}{subsubsection}{C9: Structured Decision Procedure}
		\[
		t^*=2.262>1.960=z^*
		\]
		\[
