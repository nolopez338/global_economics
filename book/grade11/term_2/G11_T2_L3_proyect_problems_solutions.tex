...
\begin{document}
	...
	\begin{ExamProblems}
		...
		\]
		\[
		E_t=t^*(SE)=2.262(0.816)=1.85,\quad E_z=z^*(SE)=1.960(0.816)=1.60
		\]
		\[
		...
		\]
		\[
		E_t=t^*(SE)=1.740(0.0611)=0.106,\quad E_z=z^*(SE)=1.645(0.0611)=0.101
		\]
		\[
		...
		\]
		\[
		E_t=t^*(SE)=2.756(0.741)=2.04,\quad E_z=z^*(SE)=2.576(0.741)=1.91
		\]
		\[
		...
		\subsubsection*{C5: Confidence Interval (z-statistic)}
		\[
		z^*=z_{0.025}=1.960,\quad \mu\in 35.00\pm 1.960(0.981)=35.00\pm 1.92=[33.08,\,36.92]
		\]
		...
		\]
		\[
		E_t=t^*(SE)=2.000(0.981)=1.96,\quad E_z=z^*(SE)=1.960(0.981)=1.92
		\]
		\[
		...
		\subsubsection*{C5: Confidence Interval (z-statistic)}
		\[
		z^*=z_{0.05}=1.645,\quad \mu\in 65.583\pm 1.645(0.696)=65.583\pm 1.14=[64.44,\,66.72]
		\]
		...
		\]
		\[
		E_t=t^*(SE)=1.658(0.696)=1.15,\quad E_z=z^*(SE)=1.645(0.696)=1.14
		\]
		\[
		...
		\subsubsection*{C5: Confidence Interval (z-statistic)}
		\[
		z^*=z_{0.025}=1.960,\quad \mu\in 115.24\pm 1.960(1.059)=115.24\pm 2.08=[113.16,\,117.32]
		\]
		...
		\]
		\[
		E_t=t^*(SE)=1.969(1.059)=2.08,\quad E_z=z^*(SE)=1.960(1.059)=2.08
		\]
		\[
		...
		\subsubsection*{C5: Confidence Interval (z-statistic)}
		\[
		z^*=z_{0.005}=2.576,\quad \mu\in 79.12\pm 2.576(0.399)=79.12\pm 1.03=[78.09,\,80.15]
		\]
		...
		\]
		\[
		E_t=t^*(SE)=2.586(0.399)=1.03,\quad E_z=z^*(SE)=2.576(0.399)=1.03
		\]
		\[
		...
		\subsubsection*{C5: Confidence Interval (z-statistic)}
		\[
		z^*=z_{0.025}=1.960,\quad \mu\in 158.40\pm 1.960(0.488)=158.40\pm 0.96=[157.44,\,159.36]
		\]
		...
		\]
		\[
		E_t=t^*(SE)=1.962(0.488)=0.96,\quad E_z=z^*(SE)=1.960(0.488)=0.96
		\]
		\[
		...
		\subsubsection*{C5: Confidence Interval (z-statistic)}
		\[
		z^*=z_{0.05}=1.645,\quad \mu\in 262.80\pm 1.645(0.576)=262.80\pm 0.95=[261.85,\,263.75]
		\]
		...
		\]
		\[
		E_t=t^*(SE)=1.646(0.576)=0.95,\quad E_z=z^*(SE)=1.645(0.576)=0.95
		\]
		\[
		...
		\subsubsection*{C5: Confidence Interval (z-statistic)}
		\[
		z^*=z_{0.005}=2.576,\quad \mu\in 526.24\pm 2.576(0.786)=526.24\pm 2.02=[524.22,\,528.26]
		\]
		...
		\]
		\[
		E_t=t^*(SE)=2.577(0.786)=2.03,\quad E_z=z^*(SE)=2.576(0.786)=2.02
		\]
		\[
