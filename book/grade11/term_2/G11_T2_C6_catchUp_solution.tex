...
\begin{document}
	...
	\begin{ExamProblems}
		...
		\addcontentsline{toc}{subsection}{1. Weekly Spending Sample Size}
		...
		\addcontentsline{toc}{subsection}{2. Utilities Spending Sample Size}
		...
		\addcontentsline{toc}{subsection}{3. Designer Earnings Sample Planning}
		...
		\addcontentsline{toc}{subsection}{4. Ride-Share Interval Width Planning}
		...
		\addcontentsline{toc}{subsection}{5. Confidence Level Margin Tradeoff}
		...
		\addcontentsline{toc}{subsection}{6. Delivery Cost Precision Upgrade}
		...
		\addcontentsline{toc}{subsection}{7. Subscription Margin Reduction Plan}
		...
		\addcontentsline{toc}{subsection}{8. Mobile Banking Precision Stages}
		...
		\addcontentsline{toc}{subsection}{9. Nonessential Spending Sample Upgrade}
		...
		\addcontentsline{toc}{subsection}{10. Side-Income Precision Scenarios}
		...
		\addcontentsline{toc}{subsection}{11. Dual Study Precision Comparison}
		...
		\addcontentsline{toc}{subsection}{12. Startup Cost Margin Targets}
