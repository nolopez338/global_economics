...
\addcontentsline{toc}{section}{1. Local Transport Satisfaction}
...
\addcontentsline{toc}{subsubsection}{(C7) Constructs the confidence interval for a proportion}
...
\addcontentsline{toc}{section}{2. Digital Payment Adoption}
...
\addcontentsline{toc}{section}{3. Water-Saving Appliance Use}
...
\addcontentsline{toc}{section}{4. Export Quality Compliance}
...
\addcontentsline{toc}{section}{5. Financial Literacy Completion}
...
\addcontentsline{toc}{section}{6. Regional Health Insurance Coverage}
...
\addcontentsline{toc}{section}{7. Food Safety Inspection Compliance}
...
\]
\[
\text{Decision: Policy statement supported.}
\]
...
\]
\[
0.133 \in [0.091,\,0.149]
\]
\[
\text{Decision: No clear statistical evidence of a change.}
\]
