...
\addcontentsline{toc}{subsection}{Subscription Spending Point Vs Interval}
...
\addcontentsline{toc}{subsection}{Transport Spending Estimate Limits}
...
\addcontentsline{toc}{subsection}{Rider Income Decision Risk}
...
\addcontentsline{toc}{subsection}{Product Sales Estimate Risk}
...
\addcontentsline{toc}{subsection}{Rent Mean Interval Interpretation}
...
\addcontentsline{toc}{subsection}{Designer Income Interval Advantage}
...
\addcontentsline{toc}{subsection}{Rent Commitment Decision Uncertainty}
...
\addcontentsline{toc}{subsection}{Salary Negotiation Under Uncertainty}
...
\addcontentsline{toc}{subsection}{Investment Return Sample Size Effects}
...
\addcontentsline{toc}{subsection}{Sales Study Precision Comparison}
