...
\addcontentsline{toc}{section}{Problems}
	\begin{ExamProblems}
		\item
		\section{Problem 1}
		\section{Studio Rent Record Comparison}
...
\subsection*{C2}
		...
		\item
		\section{Problem 2}
		\section{Graduate Offer Mean Assessment}
...
\subsection*{C2}
		...
		\item
		\section{Problem 3}
		\section{Gig Platform Earnings Benchmarks}
...
\subsection*{C2}
		...
		\item
		\section{Problem 4}
		\section{Metro Card Spending Review}
...
\subsection*{C2}
		...
		\item
		\section{Problem 5}
		\section{Emergency Deposit Mean Review}
...
\subsection*{C2}
		...
		\item
		\section{Problem 6}
		\section{Subscription Spending Interval Check}
...
\subsection*{C2}
		...
		\item
		\section{Problem 7}
		\section{Weekend Trip Spending Assessment}
...
\subsection*{C2}
		...
		\item
		\section{Problem 8}
		\section{Online Store Revenue Intervals}
...
\subsection*{C2}
		...
		\item
		\section{Problem 9}
		\section{Rider Earnings Group Comparison}
...
\subsection*{C2}
		...
		\item
		\section{Problem 10}
		\section{Net Deposit Interval Ranking}
...
\section*{Minimalistic solutions}
\subsection*{Problem 1}
\begin{itemize}
    \item Sample statistics: $\bar{x}=1810$, $s^2=8100$ (USD)$^2$ ($s=90$ USD).
    \item Population parameters: $\mu=1850$ USD, $\sigma^2=10000$ (USD)$^2$ ($\sigma=100$ USD).
\end{itemize}

\subsection*{Problem 2}
\begin{itemize}
    \item Sample statistics: $\bar{x}=53100$ USD, $s=5500$ USD.
    \item Population parameters: $\mu=52000$ USD, $\sigma=6000$ USD.
\end{itemize}

\subsection*{Problem 3}
\begin{itemize}
    \item Sample statistics: Platform A: $\bar{x}_A=750$ USD, $s_A^2=6400$ (USD)$^2$ ($s_A=80$ USD); Platform B: $\bar{x}_B=940$ USD, $s_B=70$ USD.
    \item Population parameters: Platform A: $\mu_A=720$ USD, $\sigma_A^2=4900$ (USD)$^2$ ($\sigma_A=70$ USD); Platform B: $\mu_B=980$ USD, $\sigma_B=80$ USD.
\end{itemize}

\subsection*{Problem 4}
\begin{itemize}
    \item Sample statistics: Group 1: $\bar{x}_1=1290$ USD, $s_1=280$ USD; Group 2: $\bar{x}_2=1410$ USD, $s_2=320$ USD.
    \item Population parameters: $\mu=1350$ USD, $\sigma=300$ USD.
\end{itemize}

\subsection*{Problem 5}
\begin{itemize}
    \item Sample statistics: Group A: $\bar{x}_A=400$ USD, $s_A^2=900$ (USD)$^2$ ($s_A=30$ USD); Group B: $\bar{x}_B=435$ USD, $s_B^2=2500$ (USD)$^2$ ($s_B=50$ USD); Group C: $\bar{x}_C=415$ USD, $s_C^2=3600$ (USD)$^2$ ($s_C=60$ USD).
    \item Population parameters: $\mu=420$ USD, $\sigma^2=1600$ (USD)$^2$ ($\sigma=40$ USD).
\end{itemize}

\subsection*{Problem 6}
\begin{itemize}
    \item Sample statistics: $\bar{x}=66$ USD (midpoint of 58 and 74), $s=24$ USD.
    \item Population parameters: $\sigma^2=400$ (USD)$^2$ ($\sigma=20$ USD); $\mu$ not provided.
\end{itemize}

\subsection*{Problem 7}
\begin{itemize}
    \item Sample statistics: $\bar{x}=450$ USD (midpoint of 420 and 480), $s=60$ USD.
    \item Population parameters: $\mu=460$ USD, $\sigma=70$ USD.
\end{itemize}

\subsection*{Problem 8}
\begin{itemize}
    \item Sample statistics: Store A: $\bar{x}_A=270$ USD (midpoint of 240 and 300), $s_A^2=1600$ (USD)$^2$ ($s_A=40$ USD); Store B: $\bar{x}_B=360$ USD (midpoint of 330 and 390), $s_B=55$ USD.
    \item Population parameters: Store A: $\mu_A=275$ USD, $\sigma_A=50$ USD; Store B: $\mu_B=350$ USD, $\sigma_B^2=3600$ (USD)$^2$ ($\sigma_B=60$ USD).
\end{itemize}

\subsection*{Problem 9}
\begin{itemize}
    \item Sample statistics: Group 1: $\bar{x}_1=720$ USD (midpoint of 680 and 760), $s_1=70$ USD; Group 2: $\bar{x}_2=740$ USD (midpoint of 700 and 780), $s_2^2=4900$ (USD)$^2$ ($s_2=70$ USD).
    \item Population parameters: $\mu=740$ USD, $\sigma^2=6400$ (USD)$^2$ ($\sigma=80$ USD).
\end{itemize}

\subsection*{Problem 10}
\begin{itemize}
    \item Sample statistics: Sample A: $\bar{x}_A=610$ USD (midpoint of 580 and 640), $s_A^2=6400$ (USD)$^2$ ($s_A=80$ USD); Sample B: $\bar{x}_B=630$ USD (midpoint of 600 and 660), $s_B=85$ USD; Sample C: $\bar{x}_C=590$ USD (midpoint of 550 and 630), $s_C^2=10000$ (USD)$^2$ ($s_C=100$ USD).
    \item Population parameters: $\mu=620$ USD, $\sigma=90$ USD.
\end{itemize}
