...
\addcontentsline{toc}{section}{Problems}
	\begin{ExamProblems}
		\item
		\section{Problem 1}
		\section{Subscription Spending Point Vs Interval}
		...
		\item
		\section{Problem 2}
		\section{Transport Spending Estimate Limits}
		...
		\item
		\section{Problem 3}
		\section{Rider Income Decision Risk}
		...
		\item
		\section{Problem 4}
		\section{Product Sales Estimate Risk}
		...
		\item
		\section{Problem 5}
		\section{Rent Mean Interval Interpretation}
		...
		\item
		\section{Problem 6}
		\section{Designer Income Interval Advantage}
		...
		\item
		\section{Problem 7}
		\section{Rent Commitment Decision Uncertainty}
		...
		\item
		\section{Problem 8}
		\section{Salary Negotiation Under Uncertainty}
		...
		\item
		\section{Problem 9}
		\section{Investment Return Sample Size Effects}
		...
		\item
		\section{Problem 10}
		\section{Sales Study Precision Comparison}
