...
\addcontentsline{toc}{section}{Problems}
	\begin{ExamProblems}
		\item
		\section{Sample Size Determination for Estimating a Mean Commute Time}
		...
		\item
		\section{Sample Size Determination for Estimating a Mean Weekly Wage}
		...
		\item
		\section{Sample Size Determination for Estimating Mean Crop Yield}
		...
		\item
		\section{Additional Sample Size Needed to Reduce Margin of Error for a Mean}
		...
		\item
		\section{Additional Sample Size Needed to Reduce Margin of Error for a Mean Exam Score}
		...
		\item
		\section{Additional Sample Size Needed to Reduce Margin of Error for Mean Water Use}
...
\boxed{68-25=43\text{ additional}}

\boxed{135-64=71\text{ additional}}
